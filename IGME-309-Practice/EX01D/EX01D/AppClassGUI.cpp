...
void Application::DrawGUI(void)
{
	...
	//About
	{
		...
		ImGui::Begin(sAbout.c_str(), (bool*)0, window_flags);
		{
			...
			ImGui::TextColored(v4Color, "Shift: Modifier");
			ImGui::TextColored(v4Color, "R: Increment/Decrement Radius");
			ImGui::TextColored(v4Color, "H: Increment/Decrement Height");
			ImGui::TextColored(v4Color, "S: Increment/Decrement Subdivisions");
			ImGui::TextColored(v4Color, "U: Increment/Decrement Sections");
			v4Color = ImColor(255, 255, 0);
			ImGui::TextColored(v4Color, "-------------------------------------------");
			ImGui::TextColored(v4Color, "Reminders: ");
			ImGui::TextColored(v4Color, "TreeBark is fHeight Tall");
			ImGui::TextColored(v4Color, "TreeBark is half fRadius");
			ImGui::TextColored(v4Color, "Each Leaf section is fHeight Tall");
			ImGui::TextColored(v4Color, "Each Leaf section is full fRadius");
		}
		ImGui::End();
	}
